...
public class QuotationService {
    ...
    @RequestMapping("/service-instances/delivery")
    public ArrayList<String> getDeliveryList(@PathVariable String applicationName) {
        ...
        for (int i=0; i < applicationsInstances.size();i++){
           ...
           delivery.add("/{applicationName}/deliverydate");
        }
        return delivery;
    }
