package distributedimagination.tracking;
...
public class TrackingService {
    ...
    @RequestMapping("/service-instances/tracking")
    public ArrayList<String> getTrackingList(@PathVariable String applicationName) {
        ...
        for (int i=0; i < applicationsInstances.size();i++){
           ...
           tracking.add("/{applicationName}/location");
        }
        return tracking;
    }
